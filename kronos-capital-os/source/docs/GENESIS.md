...
It then creates `.env.runtime` with restrictive permissions, installs the six-second freshness rule, initializes risk limits, and moves the system into NEWBORN/OBSERVER.
