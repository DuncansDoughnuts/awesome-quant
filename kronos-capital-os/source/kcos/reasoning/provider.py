...
class ReasoningProvider:
    ...
    async def hypotheses(self,context,max_items=3):
        ...
        headers={'Authorization':f'Bearer {self.api_key}','Content-Type':'application/json'}; body={'model':self.model,'messages':[{'role':'system','content':'You are the research reasoning layer of an autonomous quantitative institution. Be skeptical, falsifiable, and cost-aware.'},{'role':'user','content':json.dumps(prompt,default=str)}],'response_format':{'type':'json_object'}}
