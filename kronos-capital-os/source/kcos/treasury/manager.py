class TreasuryManager:
    ...
    def allocations(self,equity,venue_balances):
        deployable=equity*(1-self.min_cash_buffer_pct); cap=equity*self.max_venue_pct; return {'deployable':deployable,'venue_caps':{v:min(cap,deployable) for v in venue_balances}}
